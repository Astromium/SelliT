...
import { View, StyleSheet, Dimensions, StatusBar, TouchableOpacity, FlatList, ActivityIndicator, Image, ScrollView, Modal } from 'react-native'
...
const IMAGE_URL = "http://192.168.1.10:3000/public/img"
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <AppText style={[styles.headerText, { marginRight: 5 }]}>
            Hello
          </AppText>
        ...
        <View style={styles.feed}>
            <AppText style={[styles.headerText, { fontSize: 24 }]}>Latest Products</AppText>
            <FlatList
                data={data}
        ...
        <Modal animationType='slide' visible={categoryModal}>
          <CategoriesModel onBackPress={() => setCategoryModal(false)} onItemPress={item => {
            setCategory(item);
