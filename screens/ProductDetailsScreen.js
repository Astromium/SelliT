...
import { View, ScrollView, StyleSheet, Image, Dimensions, Animated, TouchableOpacity } from 'react-native'
      ...
      <ScrollView contentContainerStyle={{ alignItems: "center" }}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.productDetails}>
            <AppText style={{ color: colors.primary, fontSize: 22 }}>Product Description</AppText>
            <View style={{ paddingHorizontal: 10, paddingVertical: 20 }}>
              <AppText style={{ fontSize: 18, lineHeight: 22, textAlign: 'center', opacity: 0.75 }}>{data.description}</AppText>
            </View>
          </View>
        </View>
      </ScrollView>
